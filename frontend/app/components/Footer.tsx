...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-gray-800 text-white py-12 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">CarSafe</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Building a trust ecosystem for vehicle history with blockchain technology. 
              Total transparency from the lot to the junkyard.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; 2025 CarSafe. All rights reserved. Built with ❤️ on the blockchain.</p>
        </div>
      </div>
    </footer>
  )
